import {
  client_default
} from "./chunk-KWTWIG65.js";
import {
  d,
  l,
  p
} from "./chunk-EJGI73NC.js";
import "./chunk-TWLJ45QX.js";

// node_modules/preact/devtools/dist/devtools.module.js
"undefined" != typeof window && window.__PREACT_DEVTOOLS__ && window.__PREACT_DEVTOOLS__.attachPreact("10.11.0", l, { Fragment: p, Component: d });

// node_modules/preact/debug/dist/debug.module.js
var o = {};
function a(e) {
  return e.type === p ? "Fragment" : "function" == typeof e.type ? e.type.displayName || e.type.name : "string" == typeof e.type ? e.type : "#text";
}
var i = [];
var c = [];
function s() {
...
var u = false;
function l2(e) {
  return "function" == typeof e.type && e.type != p;
}
function f(n) {
...
function d2(n) {
  return n ? "function" == typeof n.type ? d2(n.__) : n : {};
}
var h = d.prototype.setState;
d.prototype.setState = function(n, e) {
  return null == this.__v && null == this.state && console.warn('Calling "this.setState" inside the constructor of a component is a no-op and might be a bug in your application. Instead, set "this.state = {}" directly.\n\n' + f(s())), h.call(this, n, e);
};
var v = d.prototype.forceUpdate;
function y(n) {
  var e = n.props, t = a(n), o2 = "";
  for (var r in e)
    if (e.hasOwnProperty(r) && "children" !== r) {
      var i2 = e[r];
      "function" == typeof i2 && (i2 = "function " + (i2.displayName || i2.name) + "() {}"), i2 = Object(i2) !== i2 || i2.toString ? i2 + "" : Object.prototype.toString.call(i2), o2 += " " + r + "=" + JSON.stringify(i2);
    }
  var c2 = e.children;
...
` + f(this.__v)), v.call(this, n);
  ...
  !function() {
    var n2 = l.__b, t2 = l.diffed, o2 = l.__, r2 = l.vnode, a2 = l.__r;
    l.diffed = function(n3) {
      ...
      n3.__o = c.length > 0 ? c[c.length - 1] : null, r2 && r2(n3);
    }, l.__r = function(n3) {
      l2(n3) && c.push(n3), a2 && a2(n3);
    };
  }();
  var n = false, t = l.__b, r = l.diffed, s2 = l.vnode, u2 = l.__e, h2 = l.__, v2 = l.__h, m = p2 ? { useEffect: /* @__PURE__ */ new WeakMap(), useLayoutEffect: /* @__PURE__ */ new WeakMap(), lazyPropTypes: /* @__PURE__ */ new WeakMap() } : null, b = [];
  l.__e = function(n2, e, t2, o2) {
    ...
    if ("thead" !== r2 && "tfoot" !== r2 && "tbody" !== r2 || "table" === i2.type ? "tr" === r2 && "thead" !== i2.type && "tfoot" !== i2.type && "tbody" !== i2.type && "table" !== i2.type ? console.error("Improper nesting of table. Your <tr> should have a <thead/tbody/tfoot/table> parent." + y(e) + "\n\n" + f(e)) : "td" === r2 && "tr" !== i2.type ? console.error("Improper nesting of table. Your <td> should have a <tr> parent." + y(e) + "\n\n" + f(e)) : "th" === r2 && "tr" !== i2.type && console.error("Improper nesting of table. Your <th> should have a <tr>." + y(e) + "\n\n" + f(e)) : console.error("Improper nesting of table. Your <thead/tbody/tfoot> should have a <table> parent." + y(e) + "\n\n" + f(e)), void 0 !== e.ref && "function" != typeof e.ref && "object" != typeof e.ref && !("$$typeof" in e))
    ...
    if ("function" == typeof e.type && e.type.propTypes) {
      ...
      e.type.__f && delete (l3 = function(n2, e2) {
        for (var t2 in e2)
          n2[t2] = e2[t2];
        return n2;
      }({}, l3)).ref, function(n2, e2, t2, r3, a2) {
        Object.keys(n2).forEach(function(t3) {
          var i3;
          try {
            i3 = n2[t3](e2, t3, r3, "prop", null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
          } catch (n3) {
            i3 = n3;
          }
...
// node_modules/@astrojs/preact/client-dev.js
var client_dev_default = client_default;

// dep:@astrojs_preact_client-dev__js
var astrojs_preact_client_dev_js_default = client_dev_default;
export {
  astrojs_preact_client_dev_js_default as default
};
